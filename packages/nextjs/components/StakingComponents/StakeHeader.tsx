...
const StakeHeader: React.FC = () => {
    return (
        <div className="w-full h-[25rem] flex flex-col justify-center items-center md:h-[30rem] lg:h-[40rem] bg-[url('/assets/headerbg.png')] bg-cover bg-no-repeat bg-contain "  >

            <div className="flex h-[70%] flex-col justify-between items-center lg:flex-row w-[60%]  md:w-[67%] lg:w-3/5 xl:w-3/5" >
                <div className=" w-[100%] lg:w-[45%] h-[45%]  lg:h-[65%]  bg-cover bg-no-repeat   rounded-[15px]   "
                    style={{
                    ...
                    <div className="flex flex-col p-[1rem] lg:p-[3rem] justify-between items-center rounded-[15px] ">
                        <div className="text-[25px] md:text-[55px] lg:text-[65px] xl:text-[80px] font-[600]">50 M</div>
