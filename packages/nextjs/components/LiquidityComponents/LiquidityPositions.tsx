    ...
    <div className="flex flex-col items-center justify-between w-full">
      {
        ...
        <div className="flex flex-col items-center py-4  " >
          <div>Don't see a pool you joined? <span>Import it.</span></div>
      ...
      <LiquidityPositionFooter handleAddLiquidity={handleAddLiquidity} pairContract={pairContract} token1={token0} token2={token1} reserve1={reserveA} reserve2={reserveB} slippage={slippage} setSlippageValue={setSlippage} share={share} lpTokens={lpTokens} />
